			...
			<Fragment>
				<div className="col-md-4 col-lg-4 col-xl-3 col-xxxl-2 faq-list">
					...
					<Accordion defaultActiveKey="0" className="faqSpecifications">
						<Card >
							<Card.Header >
								<Accordion.Toggle as={Link} className="collapsed" variant="link" eventKey="0" data-image-bx="Capmap3">
									Structure
								</Accordion.Toggle>
							</Card.Header>
						...
						<Card >
							<Card.Header >
								<Accordion.Toggle as={Link} className="collapsed" variant="link" eventKey="4" data-image-bx="Capmap3">
									Kitchen
								</Accordion.Toggle>
							</Card.Header>
						...
						<Card >
							<Card.Header >
								<Accordion.Toggle as={Link} className="collapsed" variant="link" eventKey="5" data-image-bx="Capmap2">
									Electrification
								</Accordion.Toggle>
							</Card.Header>
						...
						<Card >
							<Card.Header >
								<Accordion.Toggle as={Link} className="collapsed" variant="link" eventKey="7" data-image-bx="Capmap3">
									Bathrooms & Plumning
								</Accordion.Toggle>
							</Card.Header>
						...
						<Card >
							<Card.Header >
								<Accordion.Toggle as={Link} className="collapsed" variant="link" eventKey="8" data-image-bx="Capmap1">
									Water Supply
								</Accordion.Toggle>
							</Card.Header>
