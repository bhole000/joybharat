...
import box4 from './../../../images/portfolio/portfolio-box1/pic4.png';
...
const imageBlog = [
	...
	{  Large_img: box4 , tag: ['certificate', 'Abstract', 'Technology' ], },
	{  Large_img: box5 , tag: ['certificate', 'Designing','Technology'], }, 
	{  Large_img: box6 , tag: ['certificate' , 'Abstract'],  }, 
			...
			<section className="content-inner-2" data-content="PORTFOLIO">				
				<div className="container">
					<div className="section-head text-center">
						<p>VIEW PORTFOLLO</p>
						<h2 className="title m-b10">Our Achievement</h2>
					</div>
					<div className="row">
						<div className="col-lg-12 text-center">
							<div className="site-filters filter-style1 clearfix m-b20">
								<ul className="filters" data-toggle="buttons">
									...
									<TagLi name="Certificate" handlesettag={setTag} tagActive={ tag === 'Certificate' ? true : false }	 />
