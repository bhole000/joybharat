        ...
        <div className="container-fluid">
          <div className="row d-flex justify-content-md-between justify-content-center align-items-center">
            <div className="dlab-topbar-left">
              <ul>
                <li>
                  <i className="la la-phone-volume"></i>(+91)9830266108 |
                  (+91)9330275831
                </li>
                <li>
                  <i className="las la-map-marker"></i> gopinagar More
                  Haripal, Hooghly
                </li>
              </ul>
            </div>
            <div className="dlab-topbar-right">
              <ul>
                {/* <li>
                  <i className="la la-clock"></i> Mon - Sat 8.00 - 18.00
                </li> */}
                <li>
                  <i className="las la-envelope-open"></i>{" "}
                  joybharatagencies@gmail.com
                </li>
              </ul>
            </div>
          </div>
          ...
          <div className="container-fluid clearfix">
            ...
            <div className="extra-nav">
              <div className="extra-cell">
                <Link
                  to={"/contact-us-2"}
                  className="btn btn-primary btnhover13"
                >
                  Contact Now
                </Link>
              </div>
              ...
              <ul className="nav navbar-nav navbar">
                ...
                <li className="active">
                  ...
                  <ul className="sub-menu">
                    ...
                    <li>
                      <Link to={"/company-exhibition"}>Company Exhibition</Link>
                    </li>
                    {/* <li>
                      <Link to={"/price-table"}>Price Table</Link>
                    </li> */}
                    {/* <li>
                    ...
                    {/* <li>
                      <Link to={"/subscription-box-1"}>Subscription Box 1</Link>
                    </li>
                    <li>
                      <Link to={"/subscription-box-2"}>Subscription Box 2</Link>
                    </li> */}
                  </ul>
                </li>
                <li>
                  ...
                  {/* <ul className="sub-menu">
                    ...
                    <li>
                      <Link to={"/project-detail-1"}>Project Detail 1</Link>
                    </li>
                    <li>
                      <Link to={"/project-detail-2"}>Project Detail 2</Link>
                    </li>
                    <li>
                      <Link to={"/project-detail-3"}>Project Detail 3</Link>
                    </li>
                    <li>
                      <Link to={"/project-detail-4"}>Project Detail 4</Link>
                    </li>
                  </ul> */}
                </li>
                <li>
